...
if status:
    ...
    class MaterialExtended(PropertyGroup):
    ...
    class SceneExtended(PropertyGroup):
        ...
        ful_path_project : StringProperty(subtype = 'DIR_PATH', default = '')
    ...
    def register():
        ...
        bpy.types.Material.hatcher = bpy.props.PointerProperty(type = MaterialExtended)
